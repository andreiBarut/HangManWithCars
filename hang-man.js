const words = ["Toyota", "Honda", "Chevrolet", "Ford", "Mercedes", "Jeep", "BMW", "Porsche", "Subaru", "Nissan", "Cadillac", "Volkswagen", "Lexus", "Audi", "Hyundai", "Ferrari", "Volvo", "Jaguar", "Bentley", "Dodge", "Mazda", "LandRover", "Tesla", "Kia", "Chrysler", "Mitsubishi", "Maserati", "AstonMartin", "Bugatti", "Fiat", "Suzuki"];

console.log(words.length);

const imgSources = ["img/CAR1.png", "img/CAR2.png", "img/CAR3.png", "img/CAR4.png", "img/CAR5.png"];
